...
public class SoapRequester implements EligibilityInfo {
  ...
  @SneakyThrows
  private HttpsURLConnection acceptAllCertificates() {
    ...
    httpsUrlConnection = (HttpsURLConnection) eeUrl.openConnection();
  ...
  public String executeSoapCall(SOAPMessage soapRequestMessage) {
    ...
    try {
      ...
      HttpsURLConnection httpsUrlConnection = acceptAllCertificates();
