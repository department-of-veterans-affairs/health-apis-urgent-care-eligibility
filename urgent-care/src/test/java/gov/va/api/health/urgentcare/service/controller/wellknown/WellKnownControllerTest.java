...
import gov.va.api.health.urgentcare.api.information.WellKnown;
...
public class WellKnownControllerTest {
  ...
  private CapabilityStatementProperties capabilityProperties() {
  ...
  public void read() {
    WellKnownController controller =
        new WellKnownController(wellKnownProperties(), capabilityProperties());
    try {
